...
class WebSocketCommunication:
    ...
    def execute_move(self, robot, new_pose):
        ...
        #print("new_pose version2: ", new_pose)
        #current_frame_pose = robot.PoseFrame()
        #print("Current Robot Reference Frame (4x4):\n", current_frame_pose)
        #robot.MoveJ(new_pose, [None, None, None, None, None, None, 0.0, 0.0])
        robot.MoveJ(new_pose)
    ...
    async def receive_messages(self, websocket):
        async for message in websocket:
            ...
            if data.get("command") == "update_positioner":
                ...
                a_val = a_axis.get("e1", 0.0)
                b_val = b_axis.get("e2", 0.0)
                a_val = round(a_val, 5)
                b_val = round(b_val, 5)
                ...
                current_joints[6] = a_val
                current_joints[7] = b_val
