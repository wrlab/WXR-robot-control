...
class WebSocketCommunication:
    def __init__(self, host, port, robots, tools, ext_tools, rdk):
        ...
        self.position_threshold = 1 # position 임계값 설정 (단위: mm)
        ...
        while True:
            if (self.isTeleoper):
                ...
                if position and rotation:
                    ...
                    # rotation_matrix = [
                    #     [tool_pose[0, 0], tool_pose[0, 1], tool_pose[0, 2]],
                    #     [tool_pose[1, 0], tool_pose[1, 1], tool_pose[1, 2]],
                    #     [tool_pose[2, 0], tool_pose[2, 1], tool_pose[2, 2]],
                    # ]
                    #current_rot_euler = self.rdkapi_math.matrix_to_euler(rotation_matrix)
                    #print("current_rot_euler: ", current_rot_euler)
                    ...
                    #print("new_rot_matrix: ", new_rot_matrix)
                    #print("Tool rotation_matrix: ", rotation_matrix)
    ...
    async def receive_messages(self, websocket):
        async for message in websocket:
            ...
            if data.get("command") == "update_position":
                ...
                print("rotation1: ", self.rotation1)
