...
class rdkapiMath:
    ...
    def cal_ik(self, robot, new_pose, tool):
        #RDK = Robolink()
        #frame = RDK.Item('test-frame', ITEM_TYPE_FRAME)
        ...
        # print("tool(): ", tool_pose)
        #print("robot.PoseFrame(): " , frame_pose)
        # print("frame(): ", frame_pose)

        #current_tool_pose = robots[0].PoseTool()
        #print("Current Tool Pose: ", current_tool_pose)
        # frame = RDK.Item('KP2-HV500', ITEM_TYPE_FRAME)
        # robot.setPoseFrame(frame)
        # frame_pose = robot.Frame()
        # print("frame()[setPoseFrame]: ", frame_pose)

        tool_pose = robot.Tool()
        all_solutions = robot.SolveIK_All(new_pose, tool_pose)
